$(document).ready(function(){
	...
	$('.addContact').click(function(){
		...
		document.getElementById("delete_customer").style.visibility = 'hidden';
		document.getElementById("update_customer").style.visibility = 'hidden';
		document.getElementById("create_customer").style.visibility = 'visible';
        document.getElementById("customer_email").value="";
        document.getElementById("customer_phno").value="";
