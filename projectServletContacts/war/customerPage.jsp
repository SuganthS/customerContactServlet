	...
	<div class="customerPageSection">
		<div class="customerContactsListSection">
			<span><input type="button" id="logoutButton" value="logout"
				onclick="location.href='/Logout';"></span> <span><input
				type="button" id="createButton" value="Add +1"></span>
		...
		<div class="customerDetailsSection">
			<form id="customerDetailsForm">
				...
				Phone Number : <input type="text" id="phoneNumber"
					name="phoneNumber"><br> Address :<input type="text"
					id="address" name="address"><br> <input
					class="updateButton" id="createCustomer" style="display: none"
					type="button" value="create customer"><br>
			</form>
		</div>
